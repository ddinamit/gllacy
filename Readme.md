...
* Студент: [Хлын]
* Наставник: `А хуй его знает кто этот дядька`.
...
[Откройте мастер-репозиторий](https://github.com/ddinamit/gllacy) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
